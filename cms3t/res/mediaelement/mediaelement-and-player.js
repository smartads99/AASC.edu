    ...
    22: [function(_dereq_, module, exports) {
        ...
        var NativeHls = {
            ...
            load: function load(settings) {
                if (typeof Hls !== 'undefined') {
                    ...
                    settings.options.path = typeof settings.options.path === 'string' ? settings.options.path : 'https://cdnjs.cloudflare.com/ajax/libs/hls.js/0.8.1/hls.min.js';
        ...
        var HlsNativeRenderer = {
            ...
            options: {
                prefix: 'native_hls',
                hls: {
                    path: 'https://cdnjs.cloudflare.com/ajax/libs/hls.js/0.8.1/hls.min.js',
